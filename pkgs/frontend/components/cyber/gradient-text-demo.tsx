		...
		<div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8">
			<div className="max-w-4xl mx-auto space-y-12">
				...
				<section className="space-y-6">
					<h2 className="text-2xl font-bold text-white">グラデーションバリアント</h2>
					<div className="grid gap-6">
						<div className="glass p-6 rounded-xl space-y-2">
							<p className="text-sm text-slate-400">Default (Primary → Cyan → Secondary)</p>
				...
				{/* Animated Gradients */}
				<section className="space-y-6">
					<h2 className="text-2xl font-bold text-white">アニメーション付きグラデーション</h2>
					<div className="grid gap-6">
						<div className="glass p-6 rounded-xl space-y-2">
						...
						<div className="glass p-6 rounded-xl space-y-2">
							...
							<GradientText as="h3" gradient="rainbow" animate className="text-3xl">
								カラフルなアニメーション
							</GradientText>
						</div>
						...
						<div className="glass p-6 rounded-xl space-y-2">
							...
							<GradientText as="h3" gradient="sunset" animate className="text-3xl">
								サンセットグラデーション
							</GradientText>
						</div>
					</div>
				...
				<section className="space-y-6">
					...
					<div className="grid gap-6">
						...
						<div className="glass p-8 rounded-xl text-center space-y-4">
							...
							<GradientText as="h2" gradient="accent" animate className="text-4xl">
								無料トライアル実施中
							</GradientText>
						</div>
					</div>
				...
				<section className="glass p-6 rounded-xl">
					<h3 className="text-xl font-bold text-white mb-4">アクセシビリティ対応</h3>
					<p className="text-slate-300">
						このコンポーネントは <code className="text-cyan-400">prefers-reduced-motion</code> メディアクエリに対応しており、
