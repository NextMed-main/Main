				...
				<div className="flex flex-wrap gap-4">
					...
					<GlassModal>
						...
						<GlassModalContent>
							<GlassModalHeader>
								...
								<GlassModalDescription>
									This is a glass morphism modal with default styling. It features
					...
					<GlassModal>
						...
						<GlassModalContent variant="accent">
							...
							<div className="py-4">
								<p className="text-white/80 text-sm">
									Ideal for highlighting special features or futuristic elements.
								</p>
							</div>
							<GlassModalFooter>
					...
					<GlassModalContent variant="primary">
						...
						<div className="py-4 space-y-4">
							<div className="space-y-2">
								<label htmlFor="research-purpose" className="text-sm font-medium text-white">
									Research Purpose
								</label>
								<input
									id="research-purpose"
